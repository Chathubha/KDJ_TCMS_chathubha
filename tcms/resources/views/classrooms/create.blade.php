<x-app-layout>
    <x-slot name="header">
        <h2 class="text-2xl font-bold text-gray-900">Add Class</h2>
    </x-slot>
            ...
            <form method="POST" action="{{ route('classrooms.store') }}" class="space-y-6">
                ...
                <div class="grid grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="name" value="{{ old('name') }}" class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-900 focus:ring-2 focus:ring-indigo-500 focus:border-transparent outline-none" placeholder="e.g. 10" required>
                    ...
                    <div>
                        ...
                        <input type="text" name="section" value="{{ old('section') }}" class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-900 focus:ring-2 focus:ring-indigo-500 focus:border-transparent outline-none" placeholder="e.g. A" required>
                ...
                <div class="grid grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="number" name="capacity" value="{{ old('capacity', 40) }}" class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-900 focus:ring-2 focus:ring-indigo-500 focus:border-transparent outline-none" min="1" max="100" required>
                ...
                <div class="flex justify-end space-x-3 pt-4">
                    ...
                    <button type="submit" class="bg-gray-900 hover:bg-gray-800 text-white font-bold py-3 px-6 rounded-xl transition shadow-sm">Create Class</button>
                </div>
            </form>
        </div>
    </div>
