<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800">Add Student</h2>
    </x-slot>
            ...
            <form method="POST" action="{{ route('students.store') }}" class="space-y-4">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="date" name="dob" value="{{ old('dob') }}" class="mt-1 block w-full border-gray-300 rounded-lg shadow-sm">
                    </div>
                    <div>
                ...
                <div>
                    ...
                    <textarea name="address" rows="3" class="mt-1 block w-full border-gray-300 rounded-lg shadow-sm">{{ old('address') }}</textarea>
                </div>
                <div>
                ...
                <div class="flex justify-end space-x-3 pt-4">
                    ...
                    <button type="submit" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg">Create Student</button>
                </div>
            </form>
        </div>
    </div>
