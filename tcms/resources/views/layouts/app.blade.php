        ...
        <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
            ...
            <nav class="flex-1 overflow-y-auto py-4 px-3 space-y-1">
                ...
                <a href="{{ route('fees.index') }}"
                   class="flex items-center px-3 py-2 text-sm font-medium rounded-lg {{ request()->routeIs('fees.*') ? 'bg-white text-gray-900 shadow-sm' : 'text-gray-400 hover:text-white hover:bg-white/5' }}">
